...
## Evaluation
You can evaluate our method by (1) downloading the DragBench dataset, (2) running [evaluation.py](evaluation.py) on DragBench-DR and DragBench-SR. You may use [utils/evaluator.py](utils/evaluator.py) to evaluate other drag editing methods.
...
Evaluate on [DragBench-DR and DragBench-SR](https://drive.google.com/file/d/1rdi4Rqka8zqHTbPyhQYtFC2UdWvAeAGV/view?usp=drive_link):
```bash
